describe("Logged in user can update order with multiple products", () => {
  beforeEach(() => {
    cy.server();
    cy.route({
      method: "GET",
    ...
    cy.route({
      ...
      response: "fixture:order_create_successfull.json",
      headers: {
        uid: "user@mail.com",
      }
    })
    cy.route({
      ...
      response: "fixture:order_update_successfull.json",
      headers: {
        uid: "user@mail.com",
      }
    })
